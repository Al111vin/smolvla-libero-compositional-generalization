...
- Gate 5 physical feasibility: incomplete. Exact, safely replayable
  trajectories have passed for tasks 0–2 (`akita_black_bowl put_on_top`),
  tasks 3–5 (`akita_black_bowl put_inside`), tasks 6–8
  (`akita_black_bowl push_to`), tasks 9–11
  (`white_yellow_mug put_on_top`), tasks 12–14
  (`white_yellow_mug put_inside`), and task 26
  (`alphabet_soup push_to`), all on layout 1. This is 16/36 logical tasks
