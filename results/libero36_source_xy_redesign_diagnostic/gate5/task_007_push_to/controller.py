...
calibrator.PUSH_INCREMENT_M = 0.00125
calibrator.MAX_PUSH_STEPS = 750
...
sys.argv = [
    ...
    "7",
    "--output",
    "/tmp/libero36_gate5_task7_isolated/calibration.csv",
    "--manifest",
    "/tmp/libero36_gate5_task7_isolated/calibration.manifest.json",
    "--attempts-dir",
    "/tmp/libero36_gate5_task7_isolated/attempts",
    "--overwrite",
]
