# Task 023 Gate-5 trajectory

This directory contains the exact, safely replayable layout-1
trajectory for task 23 (`alphabet_soup put_inside right`)
...
- staged approach: vertical clearance, high horizontal alignment, then descent
- staged clearance: 0.120 m
