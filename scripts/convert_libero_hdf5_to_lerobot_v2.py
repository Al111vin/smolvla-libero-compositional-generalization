...
def main():
    ...
    if args.expected_episodes is not None and len(demo_keys) != args.expected_episodes:
        raise ValueError(f"Expected {args.expected_episodes} episodes, got {len(demo_keys)}")

    if args.expected_frames is not None and total_frames != args.expected_frames:
        raise ValueError(f"Expected {args.expected_frames} frames, got {total_frames}")
