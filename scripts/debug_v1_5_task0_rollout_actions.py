...
task_ids = [0]
ckpt_path = "outputs/smolvla_v1_5_task0_gripper_weighted/checkpoint_final.pt"
results_path = Path("results/debug_v1_5_task0_rollout_summary.csv")
max_steps = 300
...
def run_one_task(task_id):
    ...
    action_log_path = Path("results/debug_v1_5_task0_rollout_actions.csv")
    action_log_path.parent.mkdir(parents=True, exist_ok=True)

    with open(action_log_path, "w", newline="") as af:
        ...
        awriter.writeheader()
        awriter.writerows(action_rows)

    print("ACTION LOG SAVED TO:", action_log_path)
