...
from train_smolvla_v1_6_task0_motion_gripper_weighted import build_policy, add_language_tokens, move_batch_to_device


device = "cuda"
ckpt_path = "outputs/smolvla_v1_6_task0_motion_gripper_weighted/checkpoint_final.pt"
data_path = Path(
