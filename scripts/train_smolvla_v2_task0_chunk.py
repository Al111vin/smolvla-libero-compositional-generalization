...
OUTPUT_DIR = Path("outputs/smolvla_v2_task0_chunk")
...
class MultiLiberoSmolVLADataset(Dataset):
    def __init__(
        ...
        self.hdf5_paths = [
            self.dataset_dir / "pick_up_the_black_bowl_between_the_plate_and_the_ramekin_and_place_it_on_the_plate_demo.hdf5"
        ]
        ...
        for hdf5_path in self.hdf5_paths:
            ...
            with h5py.File(hdf5_path, "r") as f:
                ...
                for demo_key in demo_keys:
                    ...
                    for step_idx in range(num_steps - self.chunk_size + 1):
    ...
    def __getitem__(self, idx):
        ...
        with h5py.File(hdf5_path, "r") as f:
            ...
            action = demo["actions"][step_idx : step_idx + self.chunk_size]
...
def main():
    print("=" * 80)
    print("SmolVLA V2 task0 chunk-action training")
